...
(Asset > Create Exporter)
* Line Counter: Counts lines of code in all scripts contained in the current selection or in the whole project if nothing is selected. (Tools > XT Utilities > Count Lines)
* Align Main Camera: selects and aligns the main camera to view in one step. (Component > XT Utilities > Align Main Camera) (Ctrl/Cmd + Alt + Space)
* Group GameObjects: groups all selected GameObjects under a new one. (GameObject > Group) (Ctrl/Cmd + G)
* Duplicate Assets: duplicates the selected assets in a smart way (i.e. duplicates scripts without compiler errors and supports for duplication of assets of different types). (Asset > Duplicate)
